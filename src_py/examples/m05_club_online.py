...
# -*- coding: cp1252 -*-
#
# @file  m05_online_club.py
# @date  2012-04-16
# @author Aroldo Souza-Leite
'''
HTML Form with CherryPy
'''
...
class Club(object):
    ...
    def __init__(self, clubname="Happy Hansen"):
    ...
    def form(self, first_name=None, last_name=None, submit_names=None):
        ...
        """.format(clubname = self.clubname,
                   first_name=first_name,
                   last_name=last_name) + str(datetime.now())
...
class NightClub(Club):
    '''
    A club with late opening hours.
    '''
    def __init__(self, clubname = 'Horrid Hawks', opening_hours = 'all night'):
        self.opening_hours = opening_hours
        Club.__init__(self, clubname = clubname)

    @cherrypy.expose
    def index(self):
        s = Club.index(self)
        s = self.clubname + '-' + s + '-'  + self.opening_hours
        return s
